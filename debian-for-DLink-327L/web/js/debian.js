function get_sshd_info()
{
	$.ajax({
			...
			async: false,
			cache: false,		
			data: {cmd:"module_Get_One_Info",f_module_name:'debian'},	
			dataType:"xml",
...
//	    my_url = "http://"+document.domain+":4711?pass=admin";
	...
	if(my_url.indexOf(":")==-1)
	{
	    my_url = "http://"+document.domain+"/debian/";
    	window.open(my_url,"debian");
    }
    else
    {
